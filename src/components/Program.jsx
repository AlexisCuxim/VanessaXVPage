...
const Program = () => {
  return (
    <section className="bg-secondary">
      <div className="container pt-6 pb-[10rem]">
        <div className="mb-8">
					<h2 className="font-rochester text-black text-center text-[1.7rem] text-text md:text-[2.5rem]">Programa</h2>
        ...
        <div className="grid grid-cols-12 gap-4 py-6">
          <div className="col-span-12 p-4 bg-primary text-white rounded-md md:col-span-6 lg:col-span-4">
            <div className="text-center">
              <p className="font-poppins font-semibold text-[1.1rem] [text-shadow:_1px_1px_1px_rgb(0_0_0_/_20%)] text-secondary mb-4 md:text-[1.3rem]">
                01
                <span className="block w-[1.5rem] h-[.1rem] bg-white mx-auto rounded-lg"></span>
              </p>
